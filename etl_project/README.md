...
## Ключевые функции:
**Основная сложность этой части процесса в том , что многие организации специально заполненны различным способ, пришлось для парсинга выбирать, подбирать регулярные выражения , которые бы позволили корректно вытянуть значения метаданных** 
